...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo#5 - Brenda Guerra", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::scale(model, glm::vec3(0.5f, 1.2f, 1.2f));
		...
		model = glm::scale(model, glm::vec3(1.0f, 0.4f, 0.3f));
		color = glm::vec3(0.6f, 0.2f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::scale(model, glm::vec3(1.0f, 0.35f, 0.3f));
